			  ...
			  <div class="panel-body">
				...
				<div class="panel-body">
        			<div class="form-group">
			  			...
			  			<textarea name="deskripsi_ilkan" class="form-control" rows = "10" readonly>{{ $low->deskripsi_iklan }}></textarea>
			  		
			  		<div class="form-group">
			  			<label class="control-label">Deskripsi Perusahaan</label>
			  			<textarea name="pers_id" class="form-control" rows = "10"  readonly>{{ $low->Perusahaan->deskripsi }}></textarea>
