		...
		<div class="container">
			...
			<div class="row">
				...
				<main id="main" class="col-md-9">
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive" src="{{asset('frn/img/blog-post.jpg')}}" alt="">
						</div>
						<div class="blog-content">
							...
							<h3>{{$lowongan->nama_low}}</h3>
							<p>{!! $lowongan->deskripsi_iklan!!}</p>
							<button class="main-btn">Lamar Sekarang</button>
						</div>
						...
						<div class="blog-author">
							<div class="media">
								<div class="media-left">
									<img class="media-object" src="{{asset('frn/img/author.jpg')}}" alt="">
								</div>
						...
						<div class="blog-comments">
							...
							<div class="media">
								<div class="media-left">
									<img class="media-object" src="{{asset('frn/img/perso2.jpg')}}" alt="">
								</div>
								<div class="media-body">
							...
							<div class="media">
								<div class="media-left">
									<img class="media-object" src="{{asset('frn/img/perso1.jpg')}}" alt="">
								</div>
								<div class="media-body">
									<h4 class="media-heading">Joe Doe<span class="time">2 min ago</span><a href="#" class="reply">Reply <i class="fa fa-reply"></i></a></h4>
									<p>Nec feugiat nisl pretium fusce id velit ut tortor pretium. Nisl purus in mollis nunc sed. Nunc non blandit massa enim nec.</p>
							...
							<div class="media">
								<div class="media-left">
									<img class="media-object" src="{{asset('frn/img/perso.jpg')}}" alt="">
								</div>
								<div class="media-body">
									<h4 class="media-heading">Joe Doe<span class="time">2 min ago</span><a href="#" class="reply">Reply <i class="fa fa-reply"></i></a></h4>
									<p>Nec feugiat nisl pretium fusce id velit ut tortor pretium. Nisl purus in mollis nunc sed. Nunc non blandit massa enim nec.</p>
				...
				<aside id="aside" class="col-md-3">
					...
					<div class="widget">
						...
						<div class="widget-post">
							<a href="#">
								<img src="{{asset('frn/img/post1.jpg')}}" alt=""> Blog title goes here
							</a>
							<ul class="blog-meta">
								<li>Oct 18, 2017</li>
							</ul>
						...
						<div class="widget-post">
							<a href="#">
								<img src="{{asset('frn/img/post2.jpg')}}" alt=""> Blog title goes here
							</a>
							<ul class="blog-meta">
								<li>Oct 18, 2017</li>
							</ul>
						...
						<div class="widget-post">
							<a href="#">
								<img src="{{asset('frn/img/post3.jpg')}}" alt=""> Blog title goes here
							</a>
							<ul class="blog-meta">
								<li>Oct 18, 2017</li>
							</ul>
